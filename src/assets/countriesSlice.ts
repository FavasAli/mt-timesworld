...
export const getCountriesDetails = createAsyncThunk<Country[], string>(
...
const countriesSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      .addCase(getCountriesDetails.pending, (state) => {
        console.log("pending checking");
        state.isLoading = true;
        state.error = null;
      })
      .addCase(getCountriesDetails.fulfilled, (state, action) => {
        console.log("fulfilled checking");

        state.isLoading = false;
        state.countries = action.payload;
      })
      .addCase(getCountriesDetails.rejected, (state, action) => {
